...
public string Name { get; set; } = "";
```
<sup><a href='/src/Scry.Tests/TestModel.cs#L32-L36' title='Snippet source file'>snippet source</a> | <a href='#snippet-previousNamesMember' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
