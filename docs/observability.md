...
```
<sup><a href='/samples/Sample.Server/Program.cs#L40-L44' title='Snippet source file'>snippet source</a> | <a href='#snippet-openTelemetry' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
