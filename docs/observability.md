...
```
<sup><a href='/samples/Sample.Server/Program.cs#L44-L48' title='Snippet source file'>snippet source</a> | <a href='#snippet-openTelemetry' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
