...
```
<sup><a href='/src/Scry.Tests/ClientRoundTripTests.cs#L388-L391' title='Snippet source file'>snippet source</a> | <a href='#snippet-inProcessClient' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
