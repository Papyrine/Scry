...
```
<sup><a href='/src/Scry.SourceGenerator.Tests/GeneratorTests.EntitiesViewPocoAndEnum%23ScryEnums.g.verified.cs#L1-L12' title='Snippet source file'>snippet source</a> | <a href='#snippet-GeneratorTests.EntitiesViewPocoAndEnum#ScryEnums.g.verified.cs' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
