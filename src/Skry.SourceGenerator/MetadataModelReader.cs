...
{
    const string queryableAttribute = "Skry.QueryableAttribute";
    const string queryableViewAttribute = "Skry.QueryableViewAttribute";
    const string queryablePocoAttribute = "Skry.QueryablePocoAttribute";
    const string queryIgnoreAttribute = "Skry.QueryIgnoreAttribute";
