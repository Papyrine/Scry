...
/// <summary>Anything Skry does not expose (arrays, collections, generics other than Nullable).</summary>
sealed record OtherDecoded :
    DecodedType;

/// <summary>
/// Decodes property type signatures into <see cref="DecodedType"/> using
/// <see cref="System.Reflection.Metadata"/>, recognizing only the shapes Skry cares about.
/// </summary>
