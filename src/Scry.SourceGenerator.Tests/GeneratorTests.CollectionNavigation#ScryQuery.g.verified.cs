...
public sealed class ScryQuery
{
    ...
    /// </summary>
    public const string SchemaStamp = "hZlhN8n4rt8WMU47";
    ...
    public global::System.Linq.IQueryable<OrderQueryModel> Order =>
        client.Source<OrderQueryModel>("Order", ["Id", "Region"]);

    public global::System.Linq.IQueryable<OrderLineQueryModel> OrderLine =>
        client.Source<OrderLineQueryModel>("OrderLine", ["Id", "Price"]);
}
