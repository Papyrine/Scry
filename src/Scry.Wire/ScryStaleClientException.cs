...
/// model surface: the server rejected or failed the request and coded the error
/// <see cref="ScryErrorCode.StaleClient"/>, or a result payload could not be read into this client's
