...
public class ExecutionTests
{
    ...
    public async Task DefaultProjectionExcludesIgnoredProperty()
    {
        ...
        var json = PneumaticJson.Serialize(response);
    ...
    public Task PolicyScopesRowsBeforeClientFilter()
    {
        ...
        return Verify(Pretty(PneumaticJson.Serialize(response)));
    }
    ...
    static PneumaticProcessor Processor(Action<PneumaticOptions>? extra = null) =>
        PneumaticProcessor.Create(options =>
        {
