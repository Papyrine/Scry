...
public class SecurityTests
{
    ...
    static void AssertRejected(QueryRequest request, Action<PneumaticOptions>? extra = null)
    {
        using var context = TestContext.CreateSeeded();
        var processor = PneumaticProcessor.Create(options =>
        {
        ...
        Assert.Throws<PneumaticValidationException>(() => processor.Execute(request, context));
    }
}
