...
static class LinqDiagnostics
{
    ...
    public static DiagnosticDescriptor UnsupportedOperator = Rule(
        "SCRY100",
    ...
    public static DiagnosticDescriptor Cast = Rule(
        "SCRY101",
    ...
    public static DiagnosticDescriptor ResultSelector = Rule(
        "SCRY102",
    ...
    public static DiagnosticDescriptor Comparer = Rule(
        "SCRY103",
    ...
    public static DiagnosticDescriptor SingleUse = Rule(
        "SCRY104",
    ...
    public static DiagnosticDescriptor OrderingKey = Rule(
        "SCRY105",
    ...
    public static DiagnosticDescriptor Projection = Rule(
        "SCRY106",
    ...
    public static DiagnosticDescriptor UnsupportedFunction = Rule(
        "SCRY107",
    ...
    public static DiagnosticDescriptor FormattedToString = Rule(
        "SCRY108",
    ...
    public static DiagnosticDescriptor SynchronousExecution = Rule(
        "SCRY109",
    ...
    public static DiagnosticDescriptor UnorderedReverse = Rule(
        "SCRY110",
    ...
    public static DiagnosticDescriptor ProjectedGroup = Rule(
        "SCRY111",
    ...
    public static DiagnosticDescriptor ClientSideCode = Rule(
        "SCRY112",
    ...
    public static DiagnosticDescriptor AttachmentKeys = Error(
        "SCRY113",
    ...
    public static DiagnosticDescriptor AttachmentAsValue = Error(
        "SCRY114",
    ...
    public static DiagnosticDescriptor AttachmentOperator = Error(
        "SCRY115",
