...
Client-side LINQ provider for [Pneumatic](https://github.com/Papyrine/Pneumatic). Write ordinary LINQ
against the source-generated query models; Pneumatic captures it, serializes it to the query AST, and
