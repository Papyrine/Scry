...
namespace Pneumatic.SourceGenerator;
...
{
    const string queryableAttribute = "Pneumatic.QueryableAttribute";
    const string queryableViewAttribute = "Pneumatic.QueryableViewAttribute";
    const string queryablePocoAttribute = "Pneumatic.QueryablePocoAttribute";
    const string queryIgnoreAttribute = "Pneumatic.QueryIgnoreAttribute";
